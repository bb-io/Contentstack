...
- **Download entry content** downloads entry content converted to an HTML file, can exclude specified field IDs, and can optionally return referenced entry UIDs from the root entry.
